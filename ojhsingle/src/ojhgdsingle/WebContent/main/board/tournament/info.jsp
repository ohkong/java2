...
<table class="w3-table-all"><caption>대회소식 게시물 상세 보기</caption>
<tr><th width="20%">글쓴이</th><td colspan="2" width="80%" style="text-align:left">${b.id}</td></tr>
<tr><th>제목</th><td colspan="2" style="text-align:left">${b.title}</td></tr>
<tr><th>내용</th>
