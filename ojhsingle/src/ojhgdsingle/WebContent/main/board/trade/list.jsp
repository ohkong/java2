...
<table class="w3-table-all"><caption>거래 게시판 목록</caption>
...
<c:forEach var="b" items="${list3}">
 ...
 <c:if test="${!empty b.file1}">
      ...
      <a href="info.do?num=${b.num}&btype=${param.btype}">
      <c:if test="${b.getTradetype()!=''}">
	[${b.getTradetype()==1?'팝니다':'삽니다'}] 
	</c:if>  ${b.title}</a></td>
      </c:if>
      <c:if test="${empty b.file1}">&nbsp;&nbsp;&nbsp;
      <td style = "text-align:left">
