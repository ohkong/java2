...
public class Main3 {
	...
	public static void main(String[] args) {
		...
		System.out.println("학생 중 키가 180이상인 학생 레코드 조회하기");
		map.clear();
		//map.put("grade",1);
		map.put("height",180);
		list = session.selectList(NS+"select1",map);
		...
		System.out.println("1학년 학생 중 키가 180이상인 학생 레코드 조회하기");
		map.clear();
		map.put("grade",1);
		map.put("height",180);
		...
		System.out.println("1학년 학생 중 키가 180이상이고 몸무게가80인 학생 레코드 조회하기");
		map.clear();
		map.put("grade",1);
		map.put("height",180);
		map.put("weight",80);
